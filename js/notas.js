		...
		$.each(obj,function(i,item){
			$('#tblNotas').append(
				'<tr class="filaNotas">'+
	              	...
	              	'<td><input type="text" style="'+estilo+'" value="'+item.a+'" maxlength="2" class="nota1"/></td>'+
	              	'<td><input type="text" style="'+estilo+'" value="'+item.b+'" maxlength="2" class="nota2"/></td>'+
	              	'<td><input type="text" style="'+estilo+'" value="'+item.c+'" maxlength="2" class="nota3"/></td>'+
	              	'<td><input type="text" style="'+estilo+'" value="'+item.d+'" maxlength="2" class="nota4"/></td>'+
	              	'<td><input type="text" style="'+estilo+'" value="'+item.notafinal+'" class="notafinal"/></td>'+
...
$('#btnGrabarNotas').click(function(){
	...
	$('#tblNotas .filaNotas').each(function(){
		...
		//$.post(baseurl+"cnotas/eliminarNotas",{});
