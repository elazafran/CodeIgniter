...
class Mnotas extends CI_Model
{
	...
	public function getNotas(){
		//$q = "SELECT p.idPersona, concat(p.nombre,',', p.appaterno, ' ', p.apmaterno) alumno,
		...
		//$this->db->select("p.idPersona,  p.apmaterno alumno, n.1B, n.2B, n.3B, n.4B, n.notafinal",false);
